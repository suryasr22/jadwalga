	...
	<div class="container mh-100 col-9">
		<div class="row">
			<div class="col-lg-9 mx-auto">
				<br>
				<h1 class="mt-5 text-center">Data Admin</h1><hr><br>
				      ...
				      <th></th>
						...
						<tbody>
				          ...
				          while($admin = $dataAdmin->fetch_assoc()){
				            ...
				            if($tgt === '0'){
				            	echo "
					            	<a onclick =\"return confirm('Yakin Ingin menghapus data admin?')\" href=\"process/hapus_admin.php?id=$admin[id]\" class=\"btn btn-danger btn-sm\" role=\"button\"><i class=\"fa fa-trash-o\"></i></a>
					                </td>
				              	</tr>
					            ";
				            }				            
