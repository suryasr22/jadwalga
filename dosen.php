				      ...
				      <th></th>
						...
						<tbody>
				          ...
				          while($dosen = $dataDosen->fetch_assoc()){
				            ...
				            echo "
				                <td align =\"right\">
				                  <a href=\"edit_dosen.php?id=$dosen[id]\" class=\"btn btn-primary btn-sm\" role=\"button\"><i class=\"fa fa-pencil\" data-toggle=\"modal\" data-target=\"#myModal\"></i></a>
				            ";

				            if($tgt === '0'){
				            	echo "
					            	<a onclick =\"return confirm('Yakin Ingin menghapus data?')\" href=\"process/hapus_dosen.php?id=$dosen[id]\" class=\"btn btn-danger btn-sm\" role=\"button\"><i class=\"fa fa-trash-o\"></i></a>
					                </td>
				              	</tr>
					            ";
				            }				            
