...
<body class="w-75 mx-auto shadow-lg bg-white rounded">
  ...
  <div class="container p-4 col-10">
    <br>
    <h2 class="mt-5 text-center">Daftar Mata Kuliah</h2>
    <hr><br>
    ...
    <a href="sadmin_tambah-makul.php" class="btn btn-primary active" role="button" aria-pressed="true">Tambah Makul</a>
  </div>
